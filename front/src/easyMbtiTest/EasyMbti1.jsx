...
import { MbtiProvider, useMbti } from "../easyMbtiTest/MbtiContext";

const EasyMbti1 = () => {
    const { setAnswerAt } = useMbti();
    const pageIndex = 1; // 0~11 중 1번 페이지
    ...
    return (
        <Container>
            <Card>
                ...
                <Question>
                    <h1 style={{ marginBottom: "60px" }}>연애할 때 나는?</h1>
                </Question>
                <div>
                    <ButtonLink
                        to="/EasyMbti2"
                        onClick={() => handleSelect("E")}>
                        매일 연락하고, 데이트도 자주 하고 싶어!
                    </ButtonLink>
                    <ButtonLink
                        to="/EasyMbti2"
