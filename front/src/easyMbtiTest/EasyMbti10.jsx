...
const EasyMbti10 = () => {
  ...
  const pageIndex = 9; // 0~11 중 1번 페이지
  ...
  return (
    <Container>
      <Card>
        ...
        <Question>
          <h1 style={{ marginBottom: "60px" }}>애인과 여행할 때 나는?</h1>
        </Question>
        <div>
          <ButtonLink to="/EasyMbti11" onClick={() => handleSelect("J")}>
            일정표를 빽빽하게 짜야 마음이 놓인다
          </ButtonLink>
          <ButtonLink
            to="/EasyMbti11"
