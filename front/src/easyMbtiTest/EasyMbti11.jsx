...
const EasyMbti11 = () => {
  ...
  const pageIndex = 10; // 0~11 중 1번 페이지
  ...
  return (
    <Container>
      <Card>
        ...
        <Question>
          <h1 style={{ marginBottom: "60px" }}>데이트할 때 약속 시간은?</h1>
        </Question>
        <div>
          <ButtonLink to="/EasyMbti12" onClick={() => handleSelect("J")}>
            최소 하루 전엔 정리하고 준비해야 한다
          </ButtonLink>
          <ButtonLink
            to="/EasyMbti12"
