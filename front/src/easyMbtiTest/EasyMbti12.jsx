...
const EasyMbti12 = () => {
  ...
  const pageIndex = 11; // 0~11 중 1번 페이지
  ...
  return (
    <Container>
      <Card>
        ...
        <Question>
          <h1 style={{ marginBottom: "60px" }}>기념일은 어떻게 준비해?</h1>
        </Question>
        <div>
          <ButtonLink to="/ResultMbti" onClick={() => handleSelect("J")}>
            미리 준비하고 체크리스트까지 만든다
          </ButtonLink>
          <ButtonLink
            to="/ResultMbti"
