...
const EasyMbti4 = () => {
  ...
  const pageIndex = 3; // 0~11 중 1번 페이지
  ...
  return (
    <Container>
      <Card>
        ...
        <Question>
          <h1 style={{ marginBottom: "60px" }}>미래 얘기 나올 때 나는?</h1>
        </Question>
        <div>
          <ButtonLink to="/EasyMbti5" onClick={() => handleSelect("S")}>
            “우리 5년 뒤엔 어디서 살고 있을까?” 상상 폭발
          </ButtonLink>
          <ButtonLink
            to="/EasyMbti5"
