...
const EasyMbti5 = () => {
  ...
  const pageIndex = 4; // 0~11 중 1번 페이지
  ...
  return (
    <Container>
      <Card>
        ...
        <Question>
          <h1 style={{ marginBottom: "60px" }}>연인이 편지를 써줬다!</h1>
        </Question>
        <div>
          <ButtonLink to="/EasyMbti6" onClick={() => handleSelect("S")}>
            문장에 담긴 의미와 숨은 메시지를 해석한다
          </ButtonLink>
          <ButtonLink
            to="/EasyMbti6"
