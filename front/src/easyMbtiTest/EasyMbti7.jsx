...
const EasyMbti7 = () => {
  ...
  const pageIndex = 6; // 0~11 중 1번 페이지
  ...
  return (
    <Container>
      <Card>
        ...
        <Question>
          <h1 style={{ marginBottom: "60px" }}>애인이 힘들다고 할 때 나는?</h1>
        </Question>
        <div>
          <ButtonLink to="/EasyMbti8" onClick={() => handleSelect("F")}>
            “많이 힘들었겠다… 괜찮아?” 공감부터 한다
          </ButtonLink>
          <ButtonLink
            to="/EasyMbti8"
